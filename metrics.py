...
def save_metrics_to_file(reference_path, hypothesis_path, output_file_path, model_name):
    """
    Kiszámítja a metrikákat és elmenti az eredményeket egy fájlba.

    Args:
        reference_path (str): A referencia fájl útvonala
        hypothesis_path (str): A hipotézis fájl útvonala
        output_file_path (str): A kimenet fájl útvonala
        model_name (str): A modell neve, amelyhez a metrikákat mentjük
    """
    try:
        # Szövegek betöltése
...
if __name__ == "__main__":
    ...
    reference_path = "./references/referencia_football.txt"
    hypothesis_path = "./outputs/kimenet_football_Hacker-News-Comments-Summarization-Llama-3.1-8B-Instruct.i1-Q4_K_M.gguf.txt"
    output_file_path = "./results/Hacker-News-Comments-Summarization-Llama-3.1-8B-Instruct.i1-Q4_K_M.gguf_metrics.csv"
